...
def mainEditor():
    ...
    pinkGhost = Ghost('pink', position=(800, 250), moveSpeed=1.5, size=(SPRITE_SIZE, SPRITE_SIZE),
    ...
    redGhost = Ghost('red', position=(800, 410), moveSpeed=1.5, size=(SPRITE_SIZE, SPRITE_SIZE),
    ...
    try:
        ...
        for data in characterData:
            ...
            if 'Pacman' in charType:
                ...
                pinkGhost = Ghost('pink', position=(xpos, ypos),  moveSpeed=1.5,
                                  size=(mainScreen.CELL_SIZE, mainScreen.CELL_SIZE), images=images,
                                  pathingGridController=pathingGrid)
